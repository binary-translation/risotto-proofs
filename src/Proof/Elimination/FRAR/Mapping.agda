...
module Proof.Elimination.FRAR.Mapping (dst : Execution LabelTCG) (dst-ok : FRAR-Restricted dst) where
...
events-preserved x@{event-skip uid tid} ¬x-elimᵗ x∈dst with ℕ-dec uid (elim-uid dst-ok)
... | yes refl    = ⊥-elim (¬x-elimᵗ (unique-ids dst-wf uid (has-uid-skip , x∈dst) (elim-has-uid dst-ok , elim∈ex dst-ok)))
