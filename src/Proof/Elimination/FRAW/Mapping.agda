...
module Proof.Elimination.FRAW.Mapping (dst : Execution LabelTCG) (dst-ok : FRAW-Restricted dst) where
...
events-preserved : ∀ {x : Event LabelTCG} → x ≢ elim-ev → x ∈ events dst → x ∈ events src
