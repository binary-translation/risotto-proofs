...
poˡ-e⇒p : {y : Event LabelTCG} → y ≢ src-preserved-ev → po src src-elim-ev y → po src src-preserved-ev y
...
plˡ-e⇒p : {y : Event LabelTCG} → y ≢ src-preserved-ev → po-loc src src-elim-ev y → po-loc src src-preserved-ev y
plˡ-e⇒p ¬y-pres (po[ey] , ey-sloc) = poˡ-e⇒p ¬y-pres po[ey] , trans-same-loc pe-sloc ey-sloc

plʳ-e⇒p : {x : Event LabelTCG} → po-loc src x src-elim-ev → po-loc src x src-preserved-ev
...
cohˡ-e⇒p : {y : Event LabelTCG} → y ≢ src-preserved-ev → Coh src src-elim-ev y → Coh src src-preserved-ev y
...
cohʳ-e⇒p : {x : Event LabelTCG} → Coh src x src-elim-ev → Coh src x src-preserved-ev
...
poˡ-p⇒e : {y : Event LabelTCG} → po src src-preserved-ev y → po src src-elim-ev y
poˡ-p⇒e = po-trans src-wf (proj₁ src-transform-pair)

poʳ-p⇒e : {x : Event LabelTCG} → x ≢ src-elim-ev → po src x src-preserved-ev → po src x src-elim-ev
poʳ-p⇒e ¬x-elim po[xp] = elim-⊥⊎ ¬x-elim id (unsplit-poʳ src-wf po[xp] src-transform-pair)

¬poʳ-e⇒p : {x : Event LabelTCG} → x ≢ src-elim-ev → ¬ po src x src-elim-ev → ¬ po src x src-preserved-ev
...
freʳ-e⇒p : {x : Event LabelTCG} → fre src x src-elim-ev → fre src x src-preserved-ev
freʳ-e⇒p (fr[xe] , ¬po[xe]) =
  let ¬x-elim = λ{refl → fr-irreflexive src-wf refl fr[xe]}
  in frʳ-e⇒p fr[xe] , ¬poʳ-e⇒p ¬x-elim ¬po[xe]

coeˡ-e⇒p : {y : Event LabelTCG} → y ≢ src-preserved-ev → coe src src-elim-ev y → coe src src-preserved-ev y
...
coeʳ-e⇒p : {x : Event LabelTCG} → coe src x src-elim-ev → coe src x src-preserved-ev
coeʳ-e⇒p (co[xe] , ¬po[xe]) =
  let ¬x-elim = λ{refl → co-irreflexive src-wf refl co[xe]}
  in (coʳ-e⇒p co[xe] , ¬poʳ-e⇒p ¬x-elim ¬po[xe])


ordfˡ-e⇒p : {P₁ P₂ : Pred (Event LabelTCG) ℓzero} {f : F-mode}
  → {y : Event LabelTCG}
...
ordˡ-e⇒p (ord-wr wr[ey]) = ord-wr (ordfˡ-e⇒p wr[ey] src-preserved-w)
ordˡ-e⇒p (ord-ww ww[ey]) = ord-ww (ordfˡ-e⇒p ww[ey] src-preserved-w)
ordˡ-e⇒p (ord-wm wm[ey]) = ord-wm (ordfˡ-e⇒p wm[ey] src-preserved-w)
ordˡ-e⇒p (ord-mr mr[ey]) = ord-mr (ordfˡ-e⇒p mr[ey] (w⇒rw src-preserved-w))
ordˡ-e⇒p (ord-mw mw[ey]) = ord-mw (ordfˡ-e⇒p mw[ey] (w⇒rw src-preserved-w))
ordˡ-e⇒p (ord-mm mm[ey]) = ord-mm (ordfˡ-e⇒p mm[ey] (w⇒rw src-preserved-w))
...
ordˡ-e⇒p (ord-rr rr[ey]) = ⊥-elim (disjoint-r/w _ (ord-predˡ src rr[ey] , src-elim-w))
ordˡ-e⇒p (ord-rw rw[ey]) = ⊥-elim (disjoint-r/w _ (ord-predˡ src rw[ey] , src-elim-w))
...
ordʳ-e⇒p (ord-rw rw[xe]) = ord-rw (ordfʳ-e⇒p rw[xe] src-preserved-w)
...
ordʳ-e⇒p (ord-wm wm[xe]) = ord-wm (ordfʳ-e⇒p wm[xe] (w⇒rw src-preserved-w))
ordʳ-e⇒p (ord-mw mw[xe]) = ord-mw (ordfʳ-e⇒p mw[xe] src-preserved-w)
ordʳ-e⇒p (ord-mm mm[xe]) = ord-mm (ordfʳ-e⇒p mm[xe] (w⇒rw src-preserved-w))
...
ghbiˡ-e⇒p : {y : Event LabelTCG} → y ≢ src-preserved-ev → GhbiAlt src src-elim-ev y → GhbiAlt src src-preserved-ev y
