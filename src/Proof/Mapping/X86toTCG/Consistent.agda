...
src-ax-ghb = acyclic-⊆₂ proof-alt (⊆: xhb-alt)
  ...
  xhb-alt x y (xhb-fr fr[xy]) with ⇔₂-apply-⊆₂ (internal⊎external fr src-wf) fr[xy]
  ...
  xhb-alt x y (xhb-fr fr[xy]) | inj₁ (_ , po[xy]) | ev-r is-lab-r , ev-init with po-init-first src-wf po[xy] ev-init
  xhb-alt x y (xhb-fr fr[xy]) | inj₁ (_ , po[xy]) | ev-r is-lab-r , ev-init | ()
  xhb-alt x y (xhb-fr fr[xy]) | inj₁ (_ , po[xy]) | ev-r is-rt , ev-w is-wt = xhba-xppo (xppo-r×w ((ev-r is-rt , ev-w is-wt) , po[xy]))
  xhb-alt x y (xhb-co co[xy]) with ⇔₂-apply-⊆₂ (internal⊎external co src-wf) co[xy]
